...
using SocialNetworkApp.API.Config;
using SocialNetworkApp.UnitTests.Helpers;
using System.Net;

namespace SocialNetworkApp.UnitTests.Systems.Services
{
    public class TestUsersServices
    {
        ...
        [Fact]
        public async Task GetAllUsers_WhenCalled_InvokesConfigureExtraUrl()
        {
            // Arrange
            var expectedResponse = UsersFixture.GetTestUsers();
